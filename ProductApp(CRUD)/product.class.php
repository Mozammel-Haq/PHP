...
class Product {
    ...
    public static function showProductTable(){
        ...
        foreach ($products as $row) {
            ...
            $html .= "<tr><td>$id</td><td>$name</td><td>$price</td><td>$offPrice</td><td><a href='productApp.php?searchID=$id' class='action-btn'>Edit</a><a href='productApp.php?id=$id' class='action-btn'>Delete</a></td></tr>";
        }
        $html .= "</table>";
